...
do
    ...
    do
        echo "## emb running nproc=$nproc, vs=$vs"
    ...
    do
        ...
        do
        echo "## transformer_layer running nproc=$nproc, nah=$nah, hs=$hs"
    ...
    do
        for hs in 256 512 1024 1536 1920 2304 3072 4096 #$all_hs
        do
            echo "## gpt2 running nproc=$nproc, nah=$nah, hs=$hs"
